      ...
      <main className="flex-1">
        ...
        >
          <div className="text-center mb-12">
            ...
            <h3 className="text-4xl font-bold mb-4">الاسعار لا تشمل سعر الشحن الشحن متاح لجميع المحافظات</h3>
            <div className="text-muted-foreground max-w-2xl mx-auto text-2xl">
              <p>
                يمكنك التواصل عن طريق الايميل :
                <a
                  className="underline text-blue-600"
                  href="mailto:niqabyinfo@gmail.com"
                >
                  niqabyinfo@gmail.com
                </a>
              </p>
              <p>
                يمكنك التواصل عن طريق الانستجرام :
                <a
                  className="underline text-purple-600"
                  href="https://www.instagram.com/niqaby6?igsh=am9objN6c25qMWhq"
                >
                  انستجرام
                </a>
              </p>
              <p>
                يمكنك التواصل عن طريق الفيسبوك :
                <a
                  className="underline text-blue-500"
                  href="https://www.facebook.com/Niqabyy"
                >
                  فيسبوك
                </a>
              </p>
              <p>
                يمكنك التواصل عن طريق التليفون :
                <a
                  className="underline text-green-600 "
                  dir="ltr"
                  href="tel:+201099359857"
                >
                  01099359857
                </a>
              </p>
